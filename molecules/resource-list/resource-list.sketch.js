...
(0, _react3.storiesOf)('ResourceList', module).add('default', function () {
  return _react2.default.createElement(_.ResourceList, {
    items: [{
      title: 'Item 1',
      subtitle: 'Native',
    ...
    actions: [{ icon: 'settings', handler: function handler() {}, label: 'Settings' }, { icon: 'delete', handler: function handler() {}, label: 'Delete' }]
  });
});